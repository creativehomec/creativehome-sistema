...
const displayFontRegistered = Boolean(brand.displayFont);
if (displayFontRegistered) {
  Font.register({
    family: brand.displayFont,
    src: path.join(process.cwd(), "public", "fonts", `${brand.displayFont}.ttf`),
  });
}

const displayFontFamily = displayFontRegistered
  ? brand.displayFont
  : "Helvetica-Bold";
...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontFamily: displayFontFamily, fontSize: 30, marginBottom: 4 },
  heroTitleBold: { fontFamily: displayFontFamily, fontSize: 30, fontWeight: 700, marginBottom: 12 },
