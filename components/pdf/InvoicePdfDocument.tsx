...
/**
 * Dados bancários do estúdio, no formato "Rótulo: valor" separados por "|" —
 * ex: `PIX: 00.000.000/0001-00|Banco: 077 - Inter`. Sem a variável, o bloco
 * de pagamento some do relatório.
 */
const PAYMENT = (process.env.BRAND_PAYMENT_DETAILS ?? "")
  .split("|")
...
const styles = StyleSheet.create({
  ...
  wordmark: { fontSize: 16, fontWeight: 700, letterSpacing: -0.3 },
    ...
    >
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.wordmark}>{brand.legalName}</Text>
