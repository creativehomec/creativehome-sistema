...
export function SidebarFrame({
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-2 m-2 mr-0 flex h-[calc(100svh_-_1rem)] flex-col rounded-xl border border-neutral-200 bg-neutral-50 shadow-[0_1px_2px_rgba(30,28,24,0.04)]">
