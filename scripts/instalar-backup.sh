...
DESTINO_SCRIPT="$HOME/Library/Application Support/creativehome"
DESTINO_CONFIG="$HOME/.config/creativehome"
AGENTE="$HOME/Library/LaunchAgents/com.creativehome.backup.plist"
ROTULO="com.creativehome.backup"

mkdir -p "$DESTINO_SCRIPT" "$DESTINO_CONFIG" "$HOME/Backups/creativehome"
...
<dict>
  ...
  <string>$HOME/Backups/creativehome/backup.log</string>
...
echo "  tail -3 ~/Backups/creativehome/backup.log"
